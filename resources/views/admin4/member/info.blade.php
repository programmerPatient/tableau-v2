    ...
    <form class="form form-horizontal" id="form-article-add">
        ...
        <div id="tab-system" class="HuiTab">
            ...
            <div class="row cl checkinput">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" id="website-title" placeholder="" value="{{$user['email']}}" class="input-text" name="email">
                </div>
            </div>
            <div class="row cl checkinput">
                <label class="form-label col-xs-4 col-sm-2">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input disabled type="text" id="website-title" placeholder="" value="{{$user['mobile']}}" class="input-text" name="mobile">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">
