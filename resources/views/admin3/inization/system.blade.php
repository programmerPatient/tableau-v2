    ...
    <form class="form form-horizontal" id="form-article-add">
        <div id="tab-system" class="HuiTab">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9" id="model">
                    <input type="checkbox" id="website-title" value="1" class="input-checkbox" name="public_model">
                    模式一&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" id="website-title" value="2" class="input-checkbox" name="public_model">
                    模式二&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" id="website-title" value="3" class="input-checkbox" name="public_model">
                    模式三&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" id="website-title" value="4" class="input-checkbox" name="public_model">
                    模式四
                </div>
            </div>
            <div class="row cl">
