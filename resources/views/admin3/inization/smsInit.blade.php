    ...
    <form class="form form-horizontal" id="form-article-add">
        <div id="tab-system" class="HuiTab">
            ...
            <div class="tabCon">
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" id="website-title" placeholder="新域名" value="" class="input-text" name="name">
                    </div>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" id="website-title" placeholder="" value="" class="input-text" name="sign_name">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" id="website-title" placeholder="" value="" class="input-text" name="template_code">
                </div>
            </div>
            <div class="row cl checkinput">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" id="website-title" placeholder="" value="" class="input-text" name="access_key">
                </div>
            </div>
            <div class="row cl checkinput">
                <label class="form-label col-xs-4 col-sm-2">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" id="website-title" placeholder="" value="" class="input-text" name="access_secret">
                </div>
            </div>
        </div>
        {{csrf_field()}}
