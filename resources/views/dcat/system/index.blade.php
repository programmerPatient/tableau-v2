        ...
        <div class="content-wrapper" id="pjax-container" style="top: 0;min-height: 900px;">
            ...
            <div class="content-header">
                <section class="content-header breadcrumbs-top">
                    <h1 class=" float-left">
                        <span class="text-capitalize">系统设置</span>
                        <small></small>
                    </h1>
                                        ...
                                        <form
                                            ...
                                            <div class="box-body fields-group pl-0 pr-0 pt-1"
                                                ...
                                                <div class="form-group row form-field">
                                                    ...
                                                    <label class="col-md-2 text-capitalize asterisk control-label">tableau用户名密码是否修改</label>
                                                    ...
                                                    <div class="col-md-8 " id="same_tableau" style="padding-top: 5px;">
                                                        ...
                                                        <input
                                                            ...
                                                            data-plugin="form-oOPpetRLswitchery">
                                                        <span style="margin-right: 10px;">否</span>
                                                    </div>
                                                </div>
                                            </div>
    ...
    $(".yes_same").click(function(){
        if(this.checked){
            $("#tab-system").append(
                ...
                '                   </span>' +
                '               </span> ' +
                '               <input required="1" type="text" name="tableau_username" value="{{$default->tableau_username}}" class="form-control field_form1_text_ _normal_" placeholder="Input text"></div> </div> </div> <div class="form-group checkinput row form-field"> <div class="col-md-2 text-capitalize asterisk control-label"><span>tableau密码</span> </div> <div class="col-md-8 "> <div class="help-block with-errors"></div><div class="input-group"> <span class="input-group-prepend"><span class="input-group-text bg-white"><i class="feather icon-eye"></i></span></span> <input required="1" type="password" name="tableau_password" value="{{$default->tableau_password}}" class="form-control field_form1_password_ _normal_"placeholder="Input password"></div> </div> </div>');
        }else{
            $(".checkinput").remove();
        }
    });
