                        ...
                        @if(Session::get('user_type') == '1')
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a  href="/adminfour/report/index" class="nav-link active">
                                            &nbsp;<i class="fa fa-fw feather icon-circle"></i>
                                            <p>
                                                权限控制
                                            </p>
        ...
        <div class="content-wrapper" id="pjax-container" style="top: 0;min-height: 900px;">
            ...
            <div class="content-header">
                <section class="content-header breadcrumbs-top">
                    <h1 class=" float-left">
                        <span class="text-capitalize">权限控制</span>
                    </h1>
                        ...
                        <div class="dcat-box">
                                    ...
                                    <div class="table-responsive">
                                        <div class="top d-block clearfix p-0">
                                            ...
                                            <button type="button" data-action="refresh"
                                                    ...
                                                    style="margin-right:3px" onclick="groups()">
                                                <i class="feather icon-trash-2"></i><span class="d-none d-sm-inline">&nbsp; 批量权限映射</span>
                                            </button>
                                            <button type="button"
                                                    class="btn btn-primary btn-mini btn-outline"
                                                    style="margin-right:3px" onclick="usergroup()">
                                                <i class="feather icon-edit"></i><span class="d-none d-sm-inline">&nbsp; 批量权限组映射</span>
                                            </button>
                                            <button type="button"
                                                    class="btn btn-primary  btn-mini btn-outline "
                                                    style="margin-right:3px" onclick="expires()">
                                                <i class="feather icon-edit"></i><span class="d-none d-sm-inline">&nbsp; 批量过期时间修改</span>
                                            </button>
                                ...
                                <table class="table custom-data-table data-table table-bordered complex-headers"
                                    ...
                                    @foreach($date as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:;" onclick="member_auth('用户组映射','/adminfour/usergroup/{{$value->id}}','4','','510')" >
                                                    <input type="button" class="btn btn-primary " value="用户组映射">

                                                </a>
                                            </td>
                                            <td>
                                                <a href="javascript:;" onclick="member_auth('项目组映射','/adminfour/report/{{$value->id}}','4','','510')" >
                                                    <input type="button" class="btn btn-primary " value="项目组映射">
                                                </a>
                                            </td>
                                            <td>
                                                @if($value->expire == -1)
                                            ...
                                            <td>
                                                <button type="button"
                                                        class="btn btn-primary  btn-mini btn-outline "
                                                        style="margin-right:3px" onclick="updateExpire({{$value->id}})">
                                                    <i class="feather icon-edit"></i><span class="d-none d-sm-inline">&nbsp;过期时间修改</span>
                                                </button>
                                            </td>
                                        </tr>
                                    @endforeach
                            ...
                            <div class="box-footer d-block clearfix ">
                                <ul class="pagination pagination-sm no-margin pull-right shadow-100"
                                    ...
                                    <!-- Previous Page Link -->
                                    @if($date->currentPage()-1 > 0)
                                        <li class="page-item previous">
                                            <a class="page-link" href="?per_page={{$date->perPage()}}&page={{$date->currentPage()-1}}"></a>
                                        </li>
                                    @else
                                ...
                                <!-- Pagination Elements -->
                                    ...
                                    <!-- Array Of Links -->
                                    @if($date->currentPage()-1 > 4)
                                        <li class="page-item">
                                            <a class="page-link" href="?per_page={{$date->perPage()}}&page=1">1</a>
                                        </li>
                                        <li class="page-item disabled"><span class="page-link">...</span></li>
                                    @endif
                                    @for($v=1;$v<= $date->lastPage();$v++)
                                        @if($date->currentPage() != $v)
                                            @if($v >= $date->currentPage() - 4 && $v <= $date->currentPage() + 4)
                                                <li class="page-item">
                                                    <a class="page-link" href="?per_page={{$date->perPage()}}&page={{$v}}">{{$v}}</a>
                                                </li>
                                            @endif
                                        @else
                                        ...
                                        @endif
                                    @endfor
                                    @if($date->lastPage() - $date->currentPage() > 4)
                                        <li class="page-item disabled"><span class="page-link">...</span></li>
                                        <li class="page-item">
                                            <a class="page-link" href="?per_page={{$date->perPage()}}&page={{$date->lastPage()}}">{{$date->lastPage()}}</a>
                                        </li>
                                    @endif
                                ...
                                <!-- Array Of Links -->
                                    ...
                                    {{--                                    </li>--}}
                                <!-- Next Page Link -->
                                    @if($date->currentPage()+1 <= $date->lastPage())
                                        <li class="page-item next">
                                            <a class="page-link" href="?per_page={{$date->perPage()}}&page={{$date->currentPage()+1}}" rel="next"></a>
                                        </li>
                                    @else
                                    ...
                                    <span class="dropup" style="display:inline-block">
                                        <a id="" class="dropdown-toggle btn btn-sm btn-white waves-effect" data-toggle="dropdown"
                                           href="javascript:void(0)">
                                            <stub>{{$date->perPage()}}</stub><span class="caret"></span>
                                        </a>
