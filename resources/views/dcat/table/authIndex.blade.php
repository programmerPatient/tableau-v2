        ...
        <div class="content-wrapper" id="pjax-container" style="top: 0;min-height: 900px;">
            ...
            <div class="content-header">
                <section class="content-header breadcrumbs-top">
                    <h1 class=" float-left">
                        <span class="text-capitalize">权限管理</span>
                        <small></small>
                    </h1>
                                                ...
                                                <div class="form-group row form-field">
                                                    ...
                                                    <div class="col-md-8 ">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input required="1" id="expire" name="expire" type="text"  value=""
                                                            ...
                                                            <dl class="col-md-12 permission-list table-responsive table-collapse table-wrapper complex-container table-middle mt-1">
                                                                <dt>
                                                                    <label style="padding-top: 20px;">
                                                                        <div class="vs-radio-con vs-radio-successprimary" style="margin-right: 16px">
                                                                            <input value="" name="user-Character-0" id="user-Character-0" class="field_sex _normal_" type="checkbox">
                                                                ...
                                                                <dd>
                                                                    @foreach($value['project'] as $VieValue)
                                                                        <dl class="cl permission-list2" style="margin-left:40px">
                                                                            <dt>
                                                                            <label class="col-md-12">
                                                                                    <div class="vs-radio-con vs-radio-successprimary" style="margin-right: 16px">
                                                                                        <input value="" name="user-Character-0-1" id="user-Character-0-1" class="field_sex _normal_" type="checkbox">
                                                                                        <span class="vs-radio vs-radio-">
                                                                                          <span class="vs-radio--border"></span>
                                                                                          <span class="vs-radio--circle"></span>
                                                                                        </span>
                                                                                        <span> {{$VieValue['name']}}</span>
                                                                                    </div>
                                                                                </label>
                                                                            </dt>
                                                                            </br>
                                                                            <dd>
                                                                                @foreach($VieValue['views'] as $view)
                                                                                    <label class="col-md-10" style="margin-left:40px">
                                                                                        <div class="vs-radio-con vs-radio-successprimary" style="margin-right: 16px">
                                                                                            <input value="{{$view->id}}" name="tableauIds[]" @if(in_array($view->id,$hasTableauIds)) checked @endif  class="field_sex _normal_" type="checkbox">
                                                                                            <span class="vs-radio vs-radio-">
                                                                                            <span class="vs-radio--border"></span>
                                                                                              <span class="vs-radio--circle"></span>
                                                                                            </span>
