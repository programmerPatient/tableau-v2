        ...
        <div class="content-wrapper" id="pjax-container" style="top: 0;min-height: 900px;">
            ...
            <div class="content-header">
                <section class="content-header breadcrumbs-top">
                    <h1 class=" float-left">
                        <span class="text-capitalize">映射Tableau用户</span>
                        <small></small>
                    </h1>
                                                        ...
                                                        <div class="input-group ">
                                                            @foreach($tsResponse as $key=>$val)
                                                                <div class="vs-radio-con vs-radio-successprimary" style="margin-right: 16px">
                                                                    <input value="{{$val->name}}" name="tableauid" id="check{{$key}}" class="field_sex _normal_" type="checkbox" @if($val->name == $mamber->tableau_id) checked @endif>
