                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                @if(Session::get('user_type') == '1')
                                    ...
                                    <li class="nav-item">
                                        <a  href="/adminfour/apply/index" class="nav-link active">
                                            &nbsp;<i class="fa fa-fw feather icon-menu"></i>
                                            <p>
                                                用户申请列表
                                            </p>
        ...
        <div class="content-wrapper" id="pjax-container" style="top: 0;min-height: 900px;">
            ...
            <div class="content-header">
                <section class="content-header breadcrumbs-top">
                    <h1 class=" float-left">
                        <span class="text-capitalize">用户申请列表</span>
                    </h1>
                            ...
                            <div class="box-footer d-block clearfix ">
                                <ul class="pagination pagination-sm no-margin pull-right shadow-100"
                                    ...
                                    @if($data->currentPage()-1 > 0)
                                        <li class="page-item previous">
                                            <a class="page-link" href="/adminfour/apply/index?per_page={{$data->perPage()}}&page={{$data->currentPage()-1}}"></a>
                                        </li>
                                    @else
                                ...
                                <!-- Pagination Elements -->
                                    ...
                                    @if($data->currentPage()-1 > 4)
                                        <li class="page-item">
                                            <a class="page-link" href="/adminfour/apply/index?per_page={{$data->perPage()}}&page=1">1</a>
                                        </li>
                                    ...
                                    @for($v=1;$v<= $data->lastPage();$v++)
                                        @if($data->currentPage() != $v)
                                            @if($v >= $data->currentPage() - 4 && $v <= $data->currentPage() + 4)
                                                <li class="page-item">
                                                    <a class="page-link" href="/adminfour/apply/index?per_page={{$data->perPage()}}&page={{$v}}">{{$v}}</a>
                                                </li>
                                            @endif
                                        @else
                                    ...
                                    @if($data->lastPage() - $data->currentPage() > 4)
                                        <li class="page-item disabled"><span class="page-link">...</span></li>
                                        <li class="page-item">
                                            <a class="page-link" href="/adminfour/apply/index?per_page={{$data->perPage()}}&page={{$data->lastPage()}}">{{$data->lastPage()}}</a>
                                        </li>
                                    @endif
                                ...
                                <!-- Next Page Link -->
                                    @if($data->currentPage()+1 <= $data->lastPage())
                                        <li class="page-item next">
                                            <a class="page-link" href="/adminfour/apply/index?per_page={{$data->perPage()}}&page={{$data->currentPage()+1}}" rel="next"></a>
                                        </li>
                                    @else
                                    ...
                                    <span class="dropup" style="display:inline-block">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="dropdown-item">
                                                <a href="/adminfour/apply/index?per_page=10">10</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="/adminfour/apply/index?per_page=20">20</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="/adminfour/apply/index?per_page=30">30</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="/adminfour/apply/index?per_page=50">50</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="/adminfour/apply/index?per_page=100">100</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="/adminfour/apply/index?per_page=200">200</a>
                                            </li>
                                        </ul>
                                    </span>
                                </label>
