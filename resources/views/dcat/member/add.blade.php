                                        ...
                                        <form
                                            ...
                                            <div class="form-group row form-field">
                                                ...
                                                <div class="col-md-8 ">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-prepend"><span class="input-group-text bg-white"><i class="feather icon-edit-2"></i></span></span>
                                                        <input required="1" type="text" name="mobile" value="" class="form-control field_form1_text_ _normal_" placeholder="Input text"></div>
                                            ...
                                            <div class="form-group row form-field">
                                                ...
                                                <div class="col-md-8 ">
                                                    ...
                                                    <div class="d-flex flex-wrap">
                                                        <div class="vs-radio-con vs-radio-successprimary" style="margin-right: 16px">
                                                            <input value="1" name="excel" class="field_sex _normal_" type="radio">
                                                            <span class="vs-radio vs-radio-">
                                                              <span class="vs-radio--border"></span>
                                                              <span class="vs-radio--circle"></span>
                                                            </span>
                                                        ...
                                                        <div class="vs-radio-con vs-radio-successprimary" style="margin-right: 16px">
                                                            <input value="0" name="excel" class="field_sex _normal_" type="radio" checked>
                                                            <span class="vs-radio vs-radio-">
                                                              <span class="vs-radio--border"></span>
                                                              <span class="vs-radio--circle"></span>
                                                            </span>
                                            ...
                                            <div class="form-group row form-field">
                                                ...
                                                <div class="col-md-8 ">
                                                    ...
                                                    <div class="d-flex flex-wrap">
                                                        ...
                                                        <div class="vs-radio-con vs-radio-successprimary" style="margin-right: 16px">
                                                            <input value="1" name="status" class="field_sex _normal_" type="radio">
                                                            <span class="vs-radio vs-radio-">
                                                              <span class="vs-radio--border"></span>
                                                              <span class="vs-radio--circle"></span>
                                                            </span>
                                                        ...
                                                        <div class="vs-radio-con vs-radio-successprimary" style="margin-right: 16px">
                                                            <input value="2" name="status" class="field_sex _normal_" type="radio" checked >
                                                            <span class="vs-radio vs-radio-">
                                                              <span class="vs-radio--border"></span>
                                                              <span class="vs-radio--circle"></span>
                                                            </span>
