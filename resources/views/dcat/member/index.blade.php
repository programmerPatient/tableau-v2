                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" style="padding-top: 10px">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                @if(Session::get('user_type') == '1')
                                    <li class="nav-item">
                                        <a  href="/adminfour/member/index" class="nav-link active">
                                            &nbsp;<i class="fa fa-fw feather icon-menu"></i>
                                            <p>
                                                会员列表
                                            </p>
        ...
        <div class="content-wrapper" id="pjax-container" style="top: 0;min-height: 900px;">
            ...
            <div class="content-header">
                <section class="content-header breadcrumbs-top">
                    <h1 class=" float-left">
                        <span class="text-capitalize">会员列表</span>
                    </h1>
                                    ...
                                    <div class="table-responsive">
                                        <div class="top d-block clearfix p-0">
                                            ...
                                            <button type="button" data-action="refresh"
                                                    class="btn btn-primary btn-mini btn-outline right"
                                                    style="margin-right:3px" onclick="member_add('添加用户','/adminfour/member/add','','510')">
                                                <i class="feather icon-trash-2"></i><span class="d-none d-sm-inline">&nbsp; 添加用户</span>
                                            </button>
                                            <button type="button" data-action="refresh"
                                                    class="btn btn-primary btn-mini btn-outline right"
                                                    style="margin-right:3px" onclick="members_add('批量添加用户','/adminfour/member/adds','','510')">
                                                <i class="feather icon-trash-2"></i><span class="d-none d-sm-inline">&nbsp; 批量添加用户</span>
                                            </button>
                                            <button type="button"
                                                    class="btn btn-primary btn-mini btn-outline"
                                                    style="margin-right:3px" onclick="auth()">
                                                <i class="feather icon-edit"></i><span class="d-none d-sm-inline">&nbsp; 批量授权</span>
                                            </button>
                                            <button type="button"
                                                    class="btn btn-primary  btn-mini btn-outline "
                                                    style="margin-right:3px" onclick="mapping()">
                                                <i class="feather icon-edit"></i><span class="d-none d-sm-inline">&nbsp; 批量映射</span>
                                            </button>
                                            <button type="button" data-action="refresh"
                                                    class="btn btn-danger btn-mini btn-outline"
                                                    style="margin-right:3px" onclick="datadel()">
                                                <i class="feather icon-trash-2"></i><span class="d-none d-sm-inline">&nbsp; 批量删除</span>
                                            </button>
                                ...
                                <table class="table custom-data-table data-table table-bordered complex-headers"
                                    ...
                                    @foreach($data as $value)
                                        <tr>
                                            ...
                                            <td>
                                                @if($value->status == '1')
                                                    <input class="grid-column-switch" data-url="http://103.39.211.179:8080/admin/tables/selector/2" data-size="small" name="state" checked="" type="checkbox" data-color="#586cb1" data-switchery="true" style="display: none;">
                                                    <span class="switchery switchery-small" value="2" onClick="Status(this,{{$value->id}})" style="background-color: rgb(88, 108, 177); border-color: rgb(88, 108, 177); box-shadow: rgb(88, 108, 177) 0px 0px 0px 11px inset; transition: border 0.4s ease 0s, box-shadow 0.4s ease 0s, background-color 1.2s ease 0s;">
                                                        <small style="left: 13px; background-color: rgb(255, 255, 255); transition: background-color 0.4s ease 0s, left 0.2s ease 0s;"></small>
                                                    </span>
                                                @else
                                                    <input class="grid-column-switch" data-url="http://103.39.211.179:8080/admin/tables/selector/1" data-size="small" name="state" checked="" type="checkbox" data-color="#586cb1" data-switchery="true" style="display: none;">
                                                    <span class="switchery switchery-small" value="1" onClick="Status(this,{{$value->id}})" style="background-color: rgb(255, 255, 255); border-color: rgb(223, 223, 223); box-shadow: rgb(223, 223, 223) 0px 0px 0px 0px inset; transition: border 0.4s ease 0s, box-shadow 0.4s ease 0s;">
                                            ...
                                            <td>
                                                @if($value->execl)
                                                    <input class="grid-column-switch" data-url="http://103.39.211.179:8080/admin/tables/selector/2" data-size="small" name="state" checked="" type="checkbox" data-color="#586cb1" data-switchery="true" style="display: none;">
                                                    <span class="switchery switchery-small" value="1" onClick="execlStatus(this,{{$value->id}})" style="background-color: rgb(88, 108, 177); border-color: rgb(88, 108, 177); box-shadow: rgb(88, 108, 177) 0px 0px 0px 11px inset; transition: border 0.4s ease 0s, box-shadow 0.4s ease 0s, background-color 1.2s ease 0s;">
                                                        <small style="left: 13px; background-color: rgb(255, 255, 255); transition: background-color 0.4s ease 0s, left 0.2s ease 0s;"></small>
                                                    </span>
                                                @else
                                                    <input class="grid-column-switch" data-url="http://103.39.211.179:8080/admin/tables/selector/1" data-size="small" name="state" checked="" type="checkbox" data-color="#586cb1" data-switchery="true" style="display: none;">
                                                    <span class="switchery switchery-small" value="0" onClick="execlStatus(this,{{$value->id}})" style="background-color: rgb(255, 255, 255); border-color: rgb(223, 223, 223); box-shadow: rgb(223, 223, 223) 0px 0px 0px 0px inset; transition: border 0.4s ease 0s, box-shadow 0.4s ease 0s;">
                                                        <small style="left: 0px; transition: background-color 0.4s ease 0s, left 0.2s ease 0s;"></small>
                                                    </span>
                                                @endif
                                            </td>
                                            <td>
                                                <a href="javascript:;" onclick="member_auth('权限管理','/adminfour/table/auth/{{$value->id}}','4','','510')">
                                                    <input type="button" class="btn btn-primary " value="权限管理">
                                                </a>
                                            </td>
                                            <td>
                                                <a href="javascript:;" onclick="member_auth('映射tableau用户','/adminfour/table/user/{{$value->id}}','4','','510')" >
                                                        <input type="button" class="btn btn-primary " value="映射">
                                            ...
                                            <td>
                                                <i class="feather icon-edit" style="font-size: 1rem" onclick="member_edit('编辑','/adminfour/member/modify/{{$value->id}}','4','','550')"></i>
                                                <i class="feather icon-trash-2" style="font-size: 1rem" onclick="member_del(this,'{{$value->id}}')"></i>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                ...
                                <ul class="pagination pagination-sm no-margin pull-right shadow-100"
                                    ...
                                    @if($data->currentPage()-1 > 0)
                                        <li class="page-item previous">
                                            <a class="page-link" href="/adminfour/member/index?per_page={{$data->perPage()}}&page={{$data->currentPage()-1}}"></a>
                                        </li>
                                    @else
                                    ...
                                    @if($data->currentPage()-1 > 4)
                                        <li class="page-item">
                                            <a class="page-link" href="/adminfour/member/index?per_page={{$data->perPage()}}&page=1">1</a>
                                        </li>
                                    ...
                                    @for($v=1;$v<= $data->lastPage();$v++)
                                        @if($data->currentPage() != $v)
                                            @if($v >= $data->currentPage() - 4 && $v <= $data->currentPage() + 4)
                                                <li class="page-item">
                                                    <a class="page-link" href="/adminfour/member/index?per_page={{$data->perPage()}}&page={{$v}}">{{$v}}</a>
                                                </li>
                                            @endif
                                        @else
                                    ...
                                    @if($data->lastPage() - $data->currentPage() > 4)
                                        <li class="page-item disabled"><span class="page-link">...</span></li>
                                        <li class="page-item">
                                            <a class="page-link" href="/adminfour/member/index?per_page={{$data->perPage()}}&page={{$data->lastPage()}}">{{$data->lastPage()}}</a>
                                        </li>
                                    @endif
...
{{--                                    </li>--}}
                                    ...
                                    @if($data->currentPage()+1 <= $data->lastPage())
                                        <li class="page-item next">
                                            <a class="page-link" href="/adminfour/member/index?per_page={{$data->perPage()}}&page={{$data->currentPage()+1}}" rel="next"></a>
                                        </li>
                                    @else
                                    ...
                                    <span class="dropup" style="display:inline-block">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="dropdown-item">
                                                <a href="/adminfour/member/index?per_page=10">10</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="/adminfour/member/index?per_page=20">20</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="/adminfour/member/index?per_page=30">30</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="/adminfour/member/index?per_page=50">50</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="/adminfour/member/index?per_page=100">100</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="/adminfour/member/index?per_page=200">200</a>
                                            </li>
                                        </ul>
                                    </span>
                                </label>
