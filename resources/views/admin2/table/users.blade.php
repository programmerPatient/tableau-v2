                        ...
                        <dl class="cl permission-list2">
                            <dd>
                                    ...
                                    <label id="checkboxarr">
                                        ...
                                        <input id="check{{$key}}" style="display: inline;" type="checkbox" value="{{$val->name}}" name="tableauid">
                                        {{$val->name}}
                                        </br>
                                        @endforeach
                                    </label>
        ...
        submitHandler:function(form){
            $(form).ajaxSubmit({
                ...
                success: function(data){
                    if(data == '1'){
                        layer.msg('批量映射成功!',{icon:1,time:1000},function(){
                        ...
                        layer.msg('批量映射失败，请注意查看!',{icon:2,time:2000});
                    }
                },
