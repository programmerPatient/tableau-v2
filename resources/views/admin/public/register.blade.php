        ...
        <div id="tab-system" class="HuiTab">
            ...
            <div class="tabCon">
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" id="website-title" placeholder="新域名" value="" class="input-text" name="company_name">
                    </div>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" id="website-title" placeholder="" value="" class="input-text" name="username">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-2 col-sm-3">
                    <input type="text" id="website-title" placeholder="" value="" class="input-text mobile" name="mobile">
                </div>
                <div class="formControls col-xs-2 col-sm-1">
                    <input type="button" id="sms" placeholder="" value="获取验证码" class="input-text">
                </div>
                ...
                <div class="formControls col-xs-2 col-sm-3">
                    <input type="text" id="website-title" placeholder="" value="" class="input-text" name="captch">
                </div>
            </div>
            <div class="row cl checkinput">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" id="website-title" placeholder="" value="" class="input-text" name="email">
                </div>
            </div>
            <div class="row cl checkinput">
                <label class="form-label col-xs-4 col-sm-2">
