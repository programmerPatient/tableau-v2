...
class IndexController extends BaseController
{
    ...
    public function index(Request $request){
        ...
        if($user = Auth::guard('member')->user()){
                ...
                if($user->isInit == '2'){
                    return redirect('/adminfour/member/initInfo');
                }
        }else{
            $tableauIds = false;
...
//                $ress = Curl::getWorkBooksViews($val->id);
        ...
        return view('dcat.index.index',compact('p','system','type','allSites','name','isexcel'));
    }
    ...
    public function welcome(){
        return view('dcat.index.welcome');
    }
    ...
    public function cacheUpdate()
    {
        ...
        Redis::set(RedisKey::$updateTime,time());
